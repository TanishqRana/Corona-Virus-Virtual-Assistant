...
API_KEY = "t7KB0QTKhDyW"
PROJECT_TOKEN = "tdxRRLeLaVCs"
RUN_TOKEN = "tSaYTcvBDRjm"
...
class Data:
    ...
    def get_data(self):
        response = requests.get("https://www.parsehub.com/api/v2/projects/"+self.project_token+"/last_ready_run/data"
        , params=self.params)
    ...
    def update_data(self):
        response = requests.post("https://www.parsehub.com/api/v2/projects/"+self.project_token+"/run", params=self.params)
